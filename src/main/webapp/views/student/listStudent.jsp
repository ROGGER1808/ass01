...
<table class="table mt-5">
    ...
    <tbody>
    <c:forEach var="student" items="${students}" varStatus="myIndex">
        <tr>
            ...
            <td><a href="<%=request.getContextPath() + "/UpdateStudent?studentId="%>${student.ID}"><i
                    class="fas fa-edit"></i></a> <a
                    href="<%=request.getContextPath() + "/DeleteStudent?studentId="%>${student.ID}"><i
